...
gravity_waves: gravity_waves.o readNetCDF.o 
#ants.o partition.o vectorization.o timeEvolve.o report.o writeText.o writeBinary.o writeNetCDF.o
	$(CXX) $(flags) -o gravity_waves gravity_waves.o  -L$(NETCDF_LIB) readNetCDF.o -lnetcdf_c++4
...
clean: 
	rm -f gravity_waves gravity_waves.o readNetCDF.o ants.o partition.o vectorization.o timeEvolve.o report.o output.dat writeText.o writeBinary.o writeNetCDF.o readText.o readBinary.o readNetCDF.o file_reading.o ants.rat ants.bin ants.nc
